...
export class SuggestionsService {
  ...
  flagUrl(pays: string): string {
    const map: Record<string, string> = {
      ...
      'nigeria': 'ng', 'ghana': 'gh', 'egypt': 'eg', 'ivory coast': 'ci',
      "côte d'ivoire": 'ci', 'cameroon': 'cm', 'south africa': 'za',
      'algeria': 'dz', 'tunisia': 'tn', 'japan': 'jp', 'south korea': 'kr',
      'korea republic': 'kr', 'china': 'cn', 'australia': 'au',
      'saudi arabia': 'sa', 'iran': 'ir', 'qatar': 'qa', 'kazakhstan': 'kz',
    };
